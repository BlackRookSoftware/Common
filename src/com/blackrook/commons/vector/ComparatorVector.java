 ...
 */
@Deprecated
public class ComparatorVector<T extends Object> extends AbstractVector<T>
{
	 ...
	 */
	public ComparatorVector(Comparator<? super T> comparator)
	{
	 ...
	 */
	public ComparatorVector(Comparator<? super T> comparator, int capacity)
	{
	 ...
	 */
	public ComparatorVector(Comparator<? super T> comparator, int capacity, int inc)
	{
		super(capacity, inc);
