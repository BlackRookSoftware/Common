...
/**
 * A special hashed queue map that maps keys to hash of objects instead of just
 * a single object. The {@link #add(String, Object)} method in this case
 ...
 * @since 2.9.0
 */
public class CaseInsensitiveHashedHashMap<V extends Object> extends CaseInsensitiveHashMap<Hash<V>>
{
	...
	/**
	 * Creates a new hashed hash map with capacity DEFAULT_CAPACITY, rehash ratio DEFAULT_REHASH.
	 * The created hashes have capacity DEFAULT_CAPACITY, rehash ratio DEFAULT_REHASH.
	 */
	public CaseInsensitiveHashedHashMap()
	{
	 ...
	 */
	public CaseInsensitiveHashedHashMap(int capacity)
	{
	 ...
	 */
	public CaseInsensitiveHashedHashMap(int capacity, float rehashRatio)
	{
	 ...
	 * @throws IllegalArgumentException if capacity is negative or ratio is 0 or less.
	 */
	public CaseInsensitiveHashedHashMap(int capacity, float rehashRatio, int hashCapacity)
	{
